...
<body>
	...
	<div class="content"style="background-color: #9370DB; width: 100%; height: auto;">
		...
		<form action="dataPOY2.php" method="get">
		...
		<table border="2">
			...
			if(isset($_GET['cari'])){
				$cari=$_GET['cari'];
				$data=mysqli_query($koneksi,"SELECT * FROM data_analisa_waste WHERE jenis_produksi='POY' AND  concat(warna,kriteria_waste,tanggal) LIKE '%".$cari."%'");
			}else{
		...
		?></table>
		<br>
		<a href="cetakPOY.php" class="tombolcetak">
		<font face="comic sans ms" size="3" color="white"><center>CETAK</center></font></a><br><br>
	</div>
<div class="footer">
